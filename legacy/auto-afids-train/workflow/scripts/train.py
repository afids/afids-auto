...
finalpredarr = finalpredarr.reshape(
    finalpredarr.shape[0] * finalpredarr.shape[1], finalpredarr.shape[2]
)

regr_rf = RandomForestRegressor(
    n_estimators=args.model_params["randomforest"]["n_estimators"],
