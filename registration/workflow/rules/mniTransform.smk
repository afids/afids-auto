rule align_mni_rigid:
    output:
        warped=bids_name(root=join(config['output_dir'],'deriv','mni_space'),kind='anat',subject='{subject}',suffix=suffix,**{'space':'MNI152NLin2009cAsym'}),
